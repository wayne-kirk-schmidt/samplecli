...
This is an example of a Subject Verb, Object CLI built in python using directory structures.
The idea is you can build out quickly your functions with minimal code.
